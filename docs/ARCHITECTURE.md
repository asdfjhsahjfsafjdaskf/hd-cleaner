...
| Cleaner, browser cleaner, itens recentes (31–33) | ✅ | `cleaner.rs`: catálogo de categorias, análise que só lista, limpeza restrita aos itens analisados e inalterados, junções nunca seguidas, temporários só com mais de 24 h, app/navegador aberto bloqueia, backup .reg das listas do Registro, categorias do Windows analisadas e limpas pelo helper. Histórico e lista de downloads do Firefox: não implementados |
